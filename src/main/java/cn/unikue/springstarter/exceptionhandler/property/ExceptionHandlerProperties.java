...
package cn.unikue.springstarter.exceptionhandler.property;
...
import cn.unikue.springstarter.exceptionhandler.config.ExceptionHandlerAutoConfiguration;
...
public class ExceptionHandlerProperties implements Serializable {
     ...
     *
     * @author David Hsing
     * @see cn.unikue.springstarter.exceptionhandler.filter.FilterExceptionHandlerFilter
     */
    @Getter
    @Setter
    @ToString
    ...
    public static class ExceptionResolver implements Serializable {
         ...
         *
         * @see cn.unikue.commonplexus.springutil.annotation.ExceptionHandlerInvokable
         */
     ...
     *
     * @author David Hsing
     * @reference "https://github.com/unikueltd/locale-change-spring-boot-starter"
     */
    @Getter
    @Setter
    @ToString
