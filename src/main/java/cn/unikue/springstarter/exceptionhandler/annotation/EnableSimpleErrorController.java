...
package cn.unikue.springstarter.exceptionhandler.annotation;
...
import cn.unikue.springstarter.exceptionhandler.registrar.SimpleErrorControllerRegistrar;
 ...
 *
 * @author David Hsing
 * @see cn.unikue.springstarter.exceptionhandler.controller.SimpleBasicErrorController
 * @see cn.unikue.springstarter.exceptionhandler.registrar.SimpleErrorControllerRegistrar
 */
...
public @interface EnableSimpleErrorController {
    ...
    /**
     * Returns whether to publish a {@link cn.unikue.springstarter.exceptionhandler.event.ServletExceptionHandledEvent} on exception or not
     *
     * @return whether to publish a {@link cn.unikue.springstarter.exceptionhandler.event.ServletExceptionHandledEvent} on exception or not
     */
