...
package cn.unikue.springstarter.exceptionhandler.controller;
...
import cn.unikue.commonplexus.javaseutil.structure.TextStampStruct;
...
import cn.unikue.commonplexus.springutil.constant.ErrorAttributeConst;
import cn.unikue.commonplexus.springutil.constant.MiscMessageConst;
import cn.unikue.commonplexus.springutil.constant.ResponseBodyConst;
import cn.unikue.commonplexus.springutil.util.LocaleHolderWraps;
import cn.unikue.commonplexus.springutil.util.MessageSourceWraps;
import cn.unikue.commonplexus.springutil.util.ValidationUtilsWraps;
...
public class DefaultBasicErrorController extends AbstractBasicErrorController {
    ...
    private Map<String, Object> generateDefaultData(@Nonnull HttpServletRequest request, @Nullable HttpStatusCode status, @Nullable Throwable cause, boolean html) {
        ...
        if (rootCause instanceof BindException) {
            ...
            TextStampStruct struct = new TextStampStruct(reasons);
